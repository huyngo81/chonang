...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "huyngo81-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/deve"
  #   chef.validation_client_name = "deve-validator"
  #   chef.validation_key_path = ".chef/deve-validator.pem"
  # end
end
